...
import sys
# sys.path.append(r"E:\PythonProject\st-gcn\torchlight\torchlight")
import argparse
import yaml
import numpy as np
...
class Processor(IO):
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument('--save_interval', type=int, default=50, help='the interval for storing models (#iteration)')
