...
from processors import tasks_num_labels
...
if __name__ == "__main__":
    ...
    text = '1.颜值高，车子大小合适，轴距长，老婆在后面抱着孩子，感觉空间不错。2.法系车还是比较厚道的，该有的基本都有。就像装倒车影像师傅说，这车壳的铁相对还是比较厚实的。'
    task = 'car'
    label = for_server(args, text=text, task=task)
    print('预测的结果为：', label)
